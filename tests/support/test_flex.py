...
@pytest.mark.parametrize(
    "expand_limits, freq, expected",
    [
        ("h", "30 min", "06, 07, 08, 09"),
        ("d", "30 min", "06, 07, 08, 09"),
        ("min", "30 min", "07, 08"),
        # Asymmetrical expand_limits - not implemented
        # (("d", "h"), "30 min", "06, 07, 08, 09"),
        # (("h", "d"), "30 min", "06, 07, 08, 09"),
    ],
)
def test_expand_limits(expand_limits, freq, expected):
    ...
    actual = split(schedule, before="5d", after="1d", expand_limits=expand_limits, available=available)
