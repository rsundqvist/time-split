...
_s_data_stop = "2022-01-13 23:00:00"
    ...
    [
        (
            ...
            [
                ...
                ("2022-01-08", "2022-01-13", "2022-01-14"),
            ],
        ),
        (
            dict(schedule="3d", before=1, after=1),
            [
                ("2022-01-02", "2022-01-05", "2022-01-08"),
                ("2022-01-05", "2022-01-08", "2022-01-11"),
                ("2022-01-08", "2022-01-11", "2022-01-14"),
            ],
        ),
        (
        ...
        (
            ...
            [
                ("2022-01-01 00:00:00", "2022-01-02 00:00:00", "2022-01-05 00:00:00"),
                ("2022-01-01 00:00:00", "2022-01-05 00:00:00", "2022-01-08 00:00:00"),
                ("2022-01-01 00:00:00", "2022-01-08 00:00:00", "2022-01-11 00:00:00"),
                ("2022-01-01 00:00:00", "2022-01-11 00:00:00", "2022-01-14 00:00:00"),
            ],
        ),
        (
        ...
        (
            ...
            [
                ("2022-01-01 23:00:00", "2022-01-07 23:00:00", _s_data_stop),
                ("2022-01-04 23:00:00", "2022-01-10 23:00:00", _s_data_stop),
            ],
        ),
        (
