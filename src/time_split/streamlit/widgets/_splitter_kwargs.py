...
class SplitterKwargsWidget:
    ...
    before_widget: SpanWidget = field(default_factory=SpanWidget)
    after_widget: SpanWidget = field(default_factory=SpanWidget)
    ...
    def select_params(self) -> DatetimeIndexSplitterKwargs:
        ...
        expand_limits = self.limits_widget.select_expand_limits()
